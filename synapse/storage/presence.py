...
class PresenceTransaction(SQLBaseTransaction):
    ...
    def disallow_presence_inbound(self, observed_localpart,
                                  observer_userid):
    ...
    def is_presence_inbound_allowed(self, observed_localpart,
                                    observer_userid):
        return self._simple_select_one(
            table="presence_allow_inbound",
            keyvalues={"observed_user_id": observed_localpart,
    ...
    def add_presence_list_pending(self, observer_localpart,
                                  observed_userid):
        return self._simple_insert(
            table="presence_list",
    ...
    def set_presence_list_accepted(self, observer_localpart,
                                   observed_userid):
        return self._simple_update_one(
            table="presence_list",
