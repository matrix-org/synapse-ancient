...
class TransportTestCase(unittest.TestCase):
    ...
    def test_send_data(self):
        """ Test that the transport data get's correctly converted into a HTTP request
        """
        test_destination = "test_destination"
        test_transaction_id = "12345"
        test_body = {"test": "test1"}
        ...
        class TestHttpClient(HttpClient):
            def put_json(self, destination, path, data):
                ...
                return defer.succeed((expected_response_code, expected_response))
        ...
        d = transport_layer.send_data(data)
        
        d.addCallback(self.assertEqual, (expected_response_code, expected_response))
    ...
    def test_trigger_get_context_metadata(self):
        ...
        class TestTransportCallbacks(TransportCallbacks):
            ...
            def on_transport_data(self, transport_data):
                ...
                test_case.assertEqual(transport_data.destination, test_local_server)
    ...
    def test_trigger_get_pdu(self):
        ...
        class TestHttpClient(HttpClient):
            ...
            def get_json(self, destination, path):
                test_case.assertEqual(destination, test_destination)
                test_case.assertEqual(path, "/pdu/%s/%s/" % (test_pdu_origin, test_pdu_id))
        ...
        d = transport_layer.trigger_get_pdu(test_destination, test_pdu_origin, test_pdu_id)
    ...
    def test_register_callbacks(self):
        ...
        class TestHttpServer(HttpServer):
            def register_path(self, method, path_pattern, callback):
                ...
                test_case.fail("Unrecognized register: %s, %s" % (method, path_pattern.pattern))
